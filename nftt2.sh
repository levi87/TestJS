...
download_extra_data() {
    MEDIA_COOKIE=$(curl ${CURL_OPTS} -s "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcks")
    IATACODE=$(curl ${CURL_OPTS} -s "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcode.txt")
    IATACODE2=$(curl ${CURL_OPTS} -s "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcode2.txt")
