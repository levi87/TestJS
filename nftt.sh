...
Media_Cookie=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcks")
IATACode=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcode.txt")
IATACode2=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcode2.txt" 2>&1)
...
function MediaUnlockTest_NetflixCDN() {
    ...
    #local IATACode2=$(curl -s --retry 3 --max-time 10 "https://raw.githubusercontent.com/levi87/TestJS/main/nfttcode2.txt" 2>&1)
...
function NA_UnlockTest() {
    ...
    wait
    local array=("Sling TV:" "Pluto TV:" "Acorn TV:" "SHOWTIME:" "encoreTVB:" "Funimation:" "Discovery" "Paramount+:" "Peacock TV:" "Popcornflix:" "Crunchyroll:" "Directv Stream:" "KOCOWA:")     echo_Result ${result} ${array}
    ShowRegion CA
    local result=$(
...
function Global_UnlockTest() {
    ...
    wait
    local array=("Dazn:" "HotStar:" "Disney+:" "Netflix:" "YouTube Premium:" "Amazon Prime Video:" "TVBAnywhere+:" "iQyi Oversea Region:" "Viu.com:" "YouTube CDN:" "YouTube Region:" "Netflix Preferred CDN:" "Spotify Registration:" "Steam Currency:" "ChatGPT:" "Bing Region:" "Instagram Licensed Audio:")
    echo_Result ${result} ${array}
    echo "======================================="
}
